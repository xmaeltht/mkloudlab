...
curl -fsSL "https://pkgs.k8s.io/core:/stable:/v${K8S_VERSION}/deb/Release.key" | gpg --batch --yes --no-tty --dearmor -o /etc/apt/keyrings/kubernetes-apt-keyring.gpg
...
cat >>/etc/hosts<<EOF
172.16.16.100   kcontroller.example.com     kcontroller
172.16.16.101   knode1.example.com    knode1
172.16.16.102   knode2.example.com    knode2
172.16.16.103   knode3.example.com    knode3
EOF
